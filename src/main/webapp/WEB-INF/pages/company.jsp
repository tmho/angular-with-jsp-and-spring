    ...
    <div class="panel panel-default" ng-repeat="company in state.companies | orderBy: 'name'">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#companies-accordion" href="#companies{{company.id}}" ng-click="findManagers(company.id)">
                    {{company.name}}
                </a>
            </h4>
        </div>
            ...
            <div class="panel-body">
                <div class="panel-group" id="managers-accordion-{{company.id}}">
                    <div class="panel panel-default" ng-repeat="manager in state.managers | orderBy: 'surname'">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#managers-accordion-{{company.id}}" href="#managers-{{company.id}}-{{manager.id}}">
